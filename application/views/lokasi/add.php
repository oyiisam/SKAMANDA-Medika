                ...
                <div class="card shadow-sm">
                    <div class="card-header d-flex flex-column flex-md-row justify-content-md-between align-items-center text-center text-md-start">
                        <h5 class="mb-2 mb-md-0 text-success text-uppercase fw-bold">
                            <i class="bx bx-edit-alt"></i> Tambah Lokasi Barang
                        </h5>
                    ...
                    <div class="card-body">
                        ...
                        <!-- Hidden atau readonly: tempat_lokasi -->
                        <div class="mb-3" hidden>
                            <input type="text" name="tempat_lokasi" id="tempat_lokasi" class="form-control" value="Klinik" readonly>
