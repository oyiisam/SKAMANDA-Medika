                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover datatable nowrap" id="dataTable" data-url="<?= base_url('barang/getDataBarang') ?>" data-table="barang" data-columns='[
                                       {"data": "no"},
                                       {"data": "kode_barang"},
                                       {"data": "nama_barang"},
                                       {"data": "nama_jenis"},
