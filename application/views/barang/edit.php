                ...
                <div class="card shadow-sm">
                    <div class="card-header d-flex flex-column flex-md-row justify-content-md-between align-items-center text-center text-md-start">
                        <h5 class="mb-2 mb-md-0 text-success text-uppercase fw-bold">
                            <i class="bx bx-package"></i> Edit Data Barang
                        </h5>
                    ...
                    <div class="card-body">
                        ...
                        <?= form_open('', ['id' => 'barang_edit']); ?>

                        <!-- Tempat Barang (hidden) -->
                        <div hidden>
                            <input type="text" name="tempat_barang" id="tempat_barang"
                                class="form-control"
                                value="<?= $barang['tempat_barang']; ?>" readonly>
                        ...
                        <div class="row mb-4 g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input value="<?= set_value('kode_barang', $barang['kode_barang']); ?>"
                                        name="kode_barang" id="kode_barang"
                                        type="text" class="form-control"
                                        placeholder="Kode Barang" required autofocus>
                        ...
                        <div class="row mb-4 g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input value="<?= set_value('nama_barang', $barang['nama_barang']); ?>"
                            ...
                            <div class="form-floating">
                                <select name="lokasi_id" id="lokasi_id" class="form-select" required>
                                    ...
                                    <?php foreach ($lokasi as $l) : ?>
                                        <option <?= $barang['lokasi_id'] == $l['id_lokasi'] ? 'selected' : ''; ?>
                                            value="<?= $l['id_lokasi'] ?>">
                        ...
                        <div hidden>
                            ...
                            <input type="date" name="expired_date_terdekat"
                                id="expired_date_terdekat"
                                value="<?= $barang['expired_date_terdekat']; ?>">
                            <input type="number" name="harga_terkini"
                                id="harga_terkini"
                                value="<?= $barang['harga_terkini']; ?>" min="0">
                        </div>
