                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header d-flex flex-column flex-md-row justify-content-md-between align-items-center text-center text-md-start">
                        <h5 class="mb-2 mb-md-0 text-success text-uppercase fw-bold">
                            <i class="bx bx-edit-alt"></i> Tambah Data User
                        </h5>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama User" value="<?= set_value('nama'); ?>" required autofocus>
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <div class="form-floating flex-grow-1">
                                        <input type="number" class="form-control" id="no_telp" name="no_telp" placeholder="Nomor HP/WA" value="<?= set_value('no_telp'); ?>" required>
