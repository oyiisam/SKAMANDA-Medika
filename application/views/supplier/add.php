                ...
                <div class="card shadow-sm">
                    <div class="card-header d-flex flex-column flex-md-row justify-content-md-between align-items-center text-center text-md-start">
                        <h5 class="mb-2 mb-md-0 text-success text-uppercase fw-bold">
                            <i class="bx bx-edit-alt"></i> Tambah Data Supplier
                        </h5>
                    ...
                    <div class="card-body">
                        ...
                        <?= form_open('', ['id' => 'supplier']); ?>

                        <!-- Hidden is_admin -->
                        <div class="col-md-9" hidden>
                            <!-- Tampilkan klinik saja -->
                        ...
                        <div class="form-floating mb-4">
                            <textarea
                                ...
                                style="height: 100px"
                                required><?= set_value('alamat_supplier'); ?></textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input
                                    value="<?= set_value('nomor_supplier'); ?>"
                                    name="nomor_supplier"
                                    id="nomor_supplier"
                                    type="number"
                                    class="form-control"
                        ...
                        <script>
                            document.getElementById('supplier').addEventListener('submit', function(event) {
