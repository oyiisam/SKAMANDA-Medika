                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover datatable nowrap" id="dataTable" data-url="<?= base_url('dokter/getData') ?>" data-table="dokter" data-columns='[
                                       {"data": "no"},
                                       {"data": "nama"},
                                       {"data": "spesialisasi"},
