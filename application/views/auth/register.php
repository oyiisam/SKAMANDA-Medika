        ...
        <div class="register-form">
            ...
            <div class="form-content">
                    ...
                    <div>
                        <div class="form-floating">
                            <input type="text" class="form-control" id="nama" name="nama"
                                value="<?= set_value('nama'); ?>" placeholder="Full Name" required>
                    ...
                    <div>
                        <div class="input-group form-floating">
                            ...
                            <input type="number" class="form-control" id="no_telp" name="no_telp"
                                value="<?= set_value('no_telp'); ?>" placeholder="Phone Number" required>
                        </div>
                ...
                <a href="#" class="btn btn-outline-success w-100 py-2">
                    <img src="<?= base_url('assets/img/icons/google.svg'); ?>" width="18" class="me-2">
                    Sign up with Google
                </a>
